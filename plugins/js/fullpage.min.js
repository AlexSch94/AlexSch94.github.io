...
!(function (e, t, n, o, r) {
    ...
    function yn(e, t) {
        return (t = 1 < arguments.length ? t : jt)
    ...
    function $n(e, t, n) {
        ...
        ;(n = void 0 === n ? {} : n),
            'function' == typeof zt.CustomEvent
                ...
                : (o = jt.createEvent('CustomEvent')).initCustomEvent(
                      t,
                      !0,
                      !0,
                      n
        ...
        function (e, E) {
            ...
            if (!Ln(u, Ft)) {
                ...
                var m,
                    ...
                    I = {
                        ...
                        touchstart:
                            'ontouchstart' in zt ? 'touchstart' : H.down,
                    },
                    B =
                    ...
                    d &&
                        ...
                        (g.destroy = function (e) {
                            Z(!1, 'internal'),
                                ...
                                e &&
                                    ...
                                    yn('img[data-srcset]').forEach(function (
                                        e
                                    ) {
                                        Ve(e, 'srcset')
                                    }),
                        ...
                        (function () {
                            ...
                            E.fixedElements &&
                                ...
                                E.scrollOverflow &&
                                    (m = E.scrollOverflowHandler.init(E))
                        })(),
                        re(!0),
                        ie(!0),
                ...
                e
                      ...
                      (function () {
                          if (o || r) {
                              ...
                              e.removeEventListener(I.touchstart, Me),
                                  e.removeEventListener(I.touchmove, ke, {
                                      passive: !1,
                                  }),
                                  e.addEventListener(I.touchstart, Me),
                                  e.addEventListener(I.touchmove, ke, {
                                      passive: !1,
                                  })
                          }
                      })())
                    : (oe(!1),
                      (function () {
                          if (o || r) {
                              E.autoScrolling &&
                                  (L.removeEventListener(I.touchmove, ke, {
                                      passive: !1,
                                  }),
                                  L.removeEventListener(I.touchmove, Te, {
                                      passive: !1,
                                ...
                                if (!o) {
                                    ...
                                    ;(t || n) &&
                                        (g.shared.isNormalScrollElement ||
                                            (ie(!1),
                                            r &&
                                                E.scrollOverflowHandler.setIscroll(
                                                    i,
                                                    !1
                                                )),
            ...
            function Le() {
                ...
                if (!T && (!E.autoScrolling || E.scrollBar)) {
                    ...
                    if (
                        ...
                        ('up' != t ? n <= Un() : o >= Un() + xn()) &&
                            (Ln(yn(Qt)[0], _t) ||
                                (Nn(yn(Qt)[0], _t), zn(Xn(yn(Qt)[0]), _t))),
                        !Ln((e = f[s]), Xt))
                    ) {
                        F = !0
                        var v,
                ...
                if (Oe(e)) {
                    ...
                    ;(_ = n.y),
                        ...
                        yn(cn, t).length && Math.abs(K - $) > Math.abs(X - _)
                            ? !a &&
                              Math.abs(K - $) >
                                  (An() / 100) * E.touchSensitivity &&
                              ($ < K ? p.m.right && fe(t) : p.m.left && de(t))
                            : E.autoScrolling &&
                              k &&
                              Math.abs(X - _) >
                                  (zt.innerHeight / 100) * E.touchSensitivity &&
                ...
                if (null != e) {
                    ...
                    if (
                        ...
                        if (
                            (null != d.activeSlide &&
                                ((u =
                                    d.activeSlide.getAttribute('data-anchor')),
                                (f = In(d.activeSlide))),
                            !d.localIsResizing)
                        ) {
                            var v = d.yMovement
                        ...
                        E.autoScrolling &&
                            ...
                            E.scrollOverflow &&
                                E.scrollOverflowHandler.beforeLeave(),
                            Nn(e, Xt),
                            zn(Xn(e), Xt),
                            Ye(e),
                            E.scrollOverflow &&
                                E.scrollOverflowHandler.onLeave(),
                            (k = g.test.isTesting),
            ...
            function Ue(e) {
                ...
                yn('video, audio', t).forEach(function (e) {
                    ...
                    yn('iframe[src*="youtube.com/embed/"]', t).forEach(
                        function (e) {
            ...
            function Ze(e) {
                2 == e.which &&
                    ((G = e.pageY), d.addEventListener('mousemove', rt))
            }
            function et(e) {
                        ...
                        : (Nn(t, Xt),
                          ...
                          (function (e, t, n) {
                              ...
                              if (E.css3) {
                                  ...
                                  (g.test.left[t.sectionIndex] = Math.round(
                                      o.left
                                  )),
                                      Ht(
                                          e,
            ...
            function st() {
                if (((T = !0), ct(), o)) {
                    ...
                    if (
                        ...
                        var t = xn()
                        Math.abs(t - J) > (20 * Math.max(J, t)) / 100 &&
                            (ve(!0), (J = t))
                    }
                } else we()
                T = !1
            ...
            function ut(e) {
                ...
                return (
                    zn(e, Wt), Tn(e, { '-webkit-transition': t, transition: t })
                )
            }
            function ft(e) {
                return Nn(e, Wt)
            ...
            function yt(e) {
                if (E.recordHistory) location.hash = e
                    ...
                    zt.history.replaceState(void 0, void 0, '#' + e)
                else {
